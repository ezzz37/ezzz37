...
<p align="left">
  <img src="https://skillicons.dev/icons?i=c,kotlin,py,js,html,css,bash,cs,ts,dotnet,react,nodejs,express,sqlite,sqlserver,git,github,docker,vscode,visualstudio,figma,linux,windows,azure,androidstudio,apple,arch,bootstrap,cloudflare,debian,fastapi,firebase,gtk,heroku,kali,mysql,neovim,npm,powershell,redhat,sublime,ubuntu," alt="Stack Tecnológico" style="vertical-align: middle;" />
